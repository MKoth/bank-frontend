...
@Component({
  selector: 'app-alert-registry-details',
  templateUrl: './alert-registry-details.component.html',
  styleUrls: ['./alert-registry-details.component.scss']
})
export class AlertRegistryDetailsComponent implements OnInit {
