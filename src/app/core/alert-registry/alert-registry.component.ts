...
@Component({
  selector: 'app-alertregistry',
  templateUrl: './alert-registry.component.html',
  styleUrls: ['./alert-registry.component.scss']
})
export class AlertRegistryComponent implements OnInit {
