...
@Component({
  selector: 'app-stepsmatricula',
  templateUrl: './stepsmatricula.component.html',
  styleUrls: ['./stepsmatricula.component.scss'],
  providers: [MessageService],
  encapsulation: ViewEncapsulation.None
})
export class StepsMatriculaComponent implements OnInit {
  ...
  {
      label: 'Incluir Matrículas',routerLink: ['/matriculaimovel'],queryParams: {'recent': 'true'},
