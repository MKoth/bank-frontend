...
@Component({
  selector: 'app-operacoestabone',
  templateUrl: './operacoestabone.component.html',
  styleUrls: ['./operacoestabone.component.scss']
})
export class OperacoestaboneComponent implements OnInit {
