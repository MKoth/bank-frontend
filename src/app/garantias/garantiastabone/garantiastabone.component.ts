...
@Component({
  selector: 'app-garantiastabone',
  templateUrl: './garantiastabone.component.html',
  styleUrls: ['./garantiastabone.component.scss']
})
export class GarantiastaboneComponent implements OnInit {
