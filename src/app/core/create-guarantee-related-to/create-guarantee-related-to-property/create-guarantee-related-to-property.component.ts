...
@Component({
  selector: 'create-guarantee-related-to-property',
  templateUrl: './create-guarantee-related-to-property.component.html',
  styleUrls: ['./create-guarantee-related-to-property.component.scss']
})
export class CreateGuaranteeRelatedToPropertyComponent implements OnInit {
  newThing = -1;
  ...
  save(){
    if(this.newThing==0){
      ...
      this.revision.guarantee.guaranteeType = "Hipotecária";
    }
